  ...
  const data: any = {
    PRODUCT: [
      ...
      },
      {
        ...
        content:
          "We offer single-family homes, condos, townhouses, apartments, and penthouses",
      },
      {
        id: "00f5a45ed8897f8090116a21",
        subject: "How can I search for properties on your website?",
        content:
          "Simply use our search bar to enter location, price range, bedrooms/bathrooms, and property type.",
      },
      {
        id: "00f5a45ed8897f8090116a23",
        subject: "Do you provide assistance for first-time homebuyers?",
        content:
          "Yes, we guide you through the process and help find suitable financing.",
      },
      {
        id: "00f5a45ed8897f8090116a24",
        subject: "What should I consider when buying a property?",
        content:
          "Location, condition, size, amenities, and future development plans.",
      },
      {
      ...
      },
      {
        ...
        subject:
          "What happens if I encounter issues with the property after purchase?",
        content:
          "We offer post-purchase support to address any concerns promptly.",
      },
      {
        id: "00f5a45ed8897f8090116a28",
        subject: "Do you offer properties in specific neighborhoods?",
        content:
          "Yes, we have listings in various neighborhoods based on your preferences.",
      },
      {
        id: "00f5a45ed8897f8090116a27",
        subject: "Can I sell my property through your website?",
        content:
          "Absolutely, we provide services for selling properties as well.",
      },
      {
        id: "00f5a45ed8897f8090116b99",
        subject:
          "What if I need help understanding legal aspects of property purchase?",
        content:
          "Our team can provide basic guidance and recommend legal professionals if needed.",
      },
    ],
    PAYMENT: [
      {
      ...
      },
      {
        ...
        content:
          "No, our services are free for buyers. Sellers pay a commission upon successful sale.",
      },
      {
        id: "00f5a45ed8897f8090116a92",
        subject: "Is there an option for installment payments?",
        content:
          "Yes, we offer installment payment plans for certain properties. Please inquire for more details.",
      },
      {
      ...
      },
      {
        ...
        content:
          "Yes, you can securely make payments online through our website's payment portal.",
      },
      {
        id: "00f5a45ed8897f8090116a95",
        subject: "What happens if there's an issue with my payment?",
        content:
          "If you encounter any issues with your payment, please contact our support team for assistance.",
      },
      {
    ...
    BUYERS: [
      {
        ...
        content:
          "Buyers should check and decide whether the property they want to buy or rent is actually suitable!",
      },
      {
      ...
      },
      {
        ...
        subject:
          "What documents do I need to provide when purchasing a property?",
        content:
      ...
      },
      {
        ...
        subject:
          "What are some red flags to watch out for when viewing properties?",
        content:
      ...
      },
      {
        ...
        subject:
          "What are the advantages of using a real estate agent when buying a property?",
        content:
      ...
      },
      {
        ...
        subject:
          "What happens if I change my mind about a property after making an offer?",
        content:
    ...
    AGENTS: [
      ...
      },
      {
        ...
        content:
          "Complete pre-licensing course, pass licensing exam, meet state requirements.",
      },
      {
        id: "00f5a45ed8897f8090116a63",
        subject: "How do I find clients as a new real estate agent?",
        content:
          "Build network, use online/offline marketing, join reputable brokerage.",
      },
      {
        id: "00f5a45ed8897f8090116a64",
        subject:
          "What are some effective marketing strategies for selling properties?",
        content:
          "Use social media, online platforms, networking events, and direct mail.",
      },
      {
        id: "00f5a45ed8897f8090116a65",
        subject: "How do I handle negotiations with buyers and sellers?",
        content:
          "Develop strong negotiation skills, understand market trends, represent client interests.",
      },
      {
        id: "00f5a45ed8897f8090116a66",
        subject:
          "What should I do to stay updated with market trends and changes?",
        content:
          "Attend industry events, follow real estate news, participate in training.",
      },
      {
      ...
      },
      {
        ...
        subject:
          "What tools and technologies should I utilize as a real estate agent?",
        content:
          "Use CRM software, virtual tours, digital marketing tools, and mobile apps.",
      },
      {
        id: "00f5a45ed8897f8090116a69",
        subject:
          "How do I ensure compliance with real estate laws and regulations?",
        content:
          "Stay updated with laws, attend education courses, consult legal professionals.",
      },
      {
        id: "00f5a45ed8897f8090116a70",
        subject: "What strategies can I use to grow my real estate business?",
        content:
          "Build relationships, provide exceptional service, seek referrals, and continuously improve skills.",
      },
    ],
    MEMBERSHIP: [
      {
      ...
      },
      {
        ...
        content:
          "We currently do not offer membership benefits, but stay tuned for updates on any future offerings.",
      },
      {
        id: "00f5a45ed8897f8090116a59",
        subject: "Is there a fee associated with becoming a member?",
        content:
          "As membership services are not available, there are no associated fees at this time.",
      },
      {
        id: "00f5a45ed8897f8090116a58",
        subject:
          "Will membership provide access to exclusive content or features?",
        content:
          "We don't currently have membership-exclusive content or features.",
      },
      {
      ...
      },
      {
        ...
        subject:
          "Do members receive discounts on property listings or services?",
        content: "Membership discounts are not part of our current offerings.",
      },
      {
        id: "00f5a45ed8897f8090116a55",
        subject:
          "Are there plans to introduce a membership program in the future?",
        content:
      ...
      },
      {
        ...
        subject:
          "What kind of content or benefits can members expect if a membership program is introduced?",
        content:
          "We're evaluating potential benefits and features, but specifics are not available yet.",
      },
      {
      ...
      },
      {
        ...
        subject:
          "Will membership grant access to exclusive deals or discounts?",
        content:
          "Membership perks, including deals or discounts, are not available at this time.",
      },
    ],
    COMMUNITY: [
      {
    ...
    OTHER: [
      ...
      },
      {
        ...
        content:
          "We currently do not offer advertising opportunities on our site.",
      },
      {
        id: "00f5a45ed8897f8090116a38",
        subject:
          "Are there sponsorship opportunities available on your platform?",
      ...
      },
      {
        ...
        subject:
          "Is there a referral program for recommending your website to others?",
        content: "We don't have a referral program in place currently.",
      },
      {
        id: "00f5a45ed8897f8090116a34",
        subject:
          "Do you offer affiliate partnerships for promoting your services?",
      ...
      },
      {
        id: "00f5a45ed8897f8090116a32",
        subject:
          "Are there any job openings or opportunities to work with your team?",
        content:
          "Currently, we do not have any job openings or opportunities available.",
      },
      {
      ...
      },
      {
        ...
        subject:
          "Can I request custom features or functionalities for your website?",
        content:
          "We're not accepting requests for custom features or functionalities.",
      },
    ],
  };
